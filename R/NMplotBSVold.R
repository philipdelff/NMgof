...
NMplotBSVold <- function(data,regex.eta,names.eta=NULL,col.id="ID",covs.num,covs.char,fun.file=identity,save=FALSE,show=TRUE,script=NULL,return.data=FALSE,title=NULL,structure="flat",debug=F){
